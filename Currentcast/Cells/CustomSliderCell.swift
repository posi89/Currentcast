...
class CustomSliderCell: NSSliderCell {
    ...
    override func drawBar(inside rect: NSRect, flipped: Bool) {
        ...
        let bg = NSBezierPath(reoundRect: rect, xRadius: barRadius, yRadius: BarRadius)
    ...
    override func drawKnob(_ knobRect: NSRect) {
        ...
        let rect = NSMakeRect(round(knobRect.origin.x), knobRect.origin.y + 0.5 * (knobRect.height - knobHeight), knobRect.width, knobHeight)
